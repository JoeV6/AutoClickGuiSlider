...
public class MainGui extends GuiScreen {
    ...
    private final Slider SliderMaxCps = new Slider(1,GuiX + 40, GuiY + 55, 56, 4, "", 1, 20, guiScale, 2.7);
    private final Slider SliderMinCps = new Slider(2,GuiX + 40, GuiY + 80, 56, 4, "", 1, 20, guiScale, 2.7);

    protected final TextButton MainButton = new TextButton(3, 0, 0, fontRendererObj.getStringWidth("On"), 2, "On", 1,
            () -> {

                if (minecraft.theWorld != null && minecraft.thePlayer != null && setup.getClickerOn().isOn()) {
